...
region_rules = {
    ...
    "camera river south -> camera river north":
        sword_helper & Has("ItemThrow"),
    "camera river north -> camera river south": sword_helper,
    ...
    "grinder south":
        ...
        & swim_helper,
    "grinder east":
        darkroom1_helper  # maybe 2
        & swim_helper,
    "factory machine generator <-> factory machine catwalk":
        Has("generator smashed"),
    "miner chest pipe entrance <-> miner chest tile":
        darkroom3_helper
        & swim_helper,
    ...
    # unrandomized doors
    "lighthouse inside <-> lighthouse": 
        Has("ItemKey"),
    "lighthouse lookout -> lighthouse": False_(),
    "lighthouse -> lighthouse lookout": False_(),
    ...
    "Overworld treasure island <-> Overworld island shack": False_(),
        # obscure: you can swim accross
    "island house -> Overworld island shack": True_(),
    "Overworld island shack -> island house": sword_helper,
    "island house -> island teleporter":
        basement_helper & darkroom1_helper,
    ...
    "factory mega entrance <-> megasword upper":
        Has("generator smashed") & darkroom1_helper,
    "factory central south <-> factory central":
        Has("generator smashed"),
    "dog house basement <-> hotel room": 
        teleport_helper
        & CanReachRegion("hotel room"),
    "dog house basement <-> shoe shop downstairs": 
        teleport_helper
        & CanReachRegion("shoe shop downstairs"),
    ...
    "coffee shop outside -> coffee shop upper beach": 
        swim_helper
        | Has("ItemCoffee")
        & sword_helper,
    ...
    "sewer island tile -> toxic waters": 
        swim_helper
        & sword_helper,
    ...
    "teleporter maze west":  darkroom1_helper, # not doing it's job, but it feels unnecessary anyway: It's still in logic to come from the west without flashlight for some reason
    "mine main north":  darkroom1_helper,
    "mine main west upper": darkroom1_helper, # so that regions don't have to be added to enforce darkroom rules on mine main north and mine main west lower
    "mine main west lower":  darkroom1_helper,
    "mine main box": darkroom1_helper, # so that regions don't have to be added to enforce darkroom rules on mine main north and mine main west lower
    "factory switch test west":  darkroom1_helper,
    "factory switch test south":  darkroom1_helper,
    "dog house basement <-> island teleporter":  
        teleport_helper
        & CanReachRegion("island teleporter")
        & darkroom1_helper,
    ...
    "coffee shop outside -> coffee shop pot stairs":  sword_helper,
        # obscure: shoes
    ...
    "factory cooler west <-> factory cooler tile":  sword_helper,
        # obscure: shoes
    ...
    "temple firebat test east":
        wateringcan_helper
        & darkroom2_helper,
    "temple firebat test west":
        wateringcan_helper
        & darkroom2_helper,
    # TODO: fix logical issues with not being able to carry a sword and a watering can at the same time
...
location_rules = {
    # Dog House
    "Dog House - ItemCoffee":
        sword_helper
        & CanReachRegion("2crab tile")
        & CanReachRegion("3crab main"),
    # "Dog House - ItemFlashLight": True_(),
    "Dog House - ItemKey":
        sword_helper & box_helper,
    ...
    "Dog House - Hidden Snake Coin":
        chest_helper & darkroom3_helper,
    "Dog House - Waterfall Coin":
        chest_helper & darkroom1_helper,
    "Dog House - Treasure Island Coin":
        chest_helper
        & swim_helper,
    "Dog House - Plant Heart":  wateringcan_helper,
    "Dog House - Bull Heart":  sword_helper,
    "Dog House - Boat Tentacle":
        sword_helper
        & HasAll("ItemBoat", "boatguy watered", "ItemGlove"),
    "Dog House - Treasure Island Tentacle":
        sword_helper & swim_helper,
    "Dog House - Sword Toss Tentacle":
        sword_helper
        & HasAll("ItemCoffee", "ItemThrow"),
    "Dog House - Sewer Tentacle":
        sword_helper & darkroom3_helper
        & swim_helper,
    ...
    # Hotel Room
    "Hotel Room - ItemSwim":
        HasAll("swimmer saved", "hostage saved", "wallet saved", "ninja saved", "bridge saved", "hidden saved"),
        # praying i can make this work
    "Hotel Room - ItemGrinder":
        darkroom2_helper
        & HasAll("ItemSwim", "ItemCoffee"),
    ...
    "Dog House - Dolphin Heart":  wateringcan_helper, # TODO: fix logical issues with not being able to carry a sword and a watering can at the same time

    # Undefined
    "Factory Main - ItemMegaSword":
        sword_helper
        & HasAll("ItemWateringCan", "left machine", "right machine"),
    ...
    "teleporter switch6": 
        ...
        & (Has("ItemCoffee")
            | swim_helper),
    "boatguy watered":  wateringcan_helper, # TODO: fix logical issues with not being able to carry a sword and a watering can at the same time
    "left machine":
        darkroom1_helper
        & HasAll("ItemSwim", "ItemCoffee"),
    "right machine":
...
obscure = {
    ...
    "lighthouse -> lighthouse lookout": swim_helper,

    # Shoes to skip breaking the pot
    "coffee shop outside -> coffee shop pot stairs": 
        sword_helper
        | Has("ItemShoes"),
    ...
    "camera river north -> camera river south": True_(),

    # Bait the sharks
    "Overworld treasure island <-> Overworld island shack": swim_helper,

    # Glitch through with precision
    "factory cooler west <-> factory cooler tile": 
        sword_helper
        | Has("ItemShoes"),
