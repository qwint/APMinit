    ...
    def __init__(self, world: MinitWorld) -> None:
        ...
        #Hotel Room
            ...
            "Hotel Room - Dog Heart": lambda state:
                ...
                #obscure: with good movemnt can do this in 50s with just sword glove, adding teleport/swim/shoes to give more wiggle room outside obscure logic
        ...
        #Underground Tent
            ...
            "Dog House - Dolphin Heart": lambda state:
                state.has("ItemWateringCan", self.player),
                #Non Vanilla Location: water the dolphin NPC south of the watering can location
