...
class ProgressiveSword(Choice):
    """Sets the Broken, Basic, and Mega swords to be Progressive Items. If set to reverse they will increment from Mega to Basic to Broken, expected to be used with Toilet Goal."""
...
class Goal(Choice):
    """Forces the player to win via a specific Goal condition. Boss is use the Mega Sword to destroy the factory machine and beat the boss. Toilet is to aquire the Broken Sword and drop it into the Factory toilet."""
    display_name = "Goal"
    option_boss_fight = 0
